...
class Application(QMainWindow, Ui_MainWindow):
    ...
    def on_mouse_click(self, event):
        ...
        if event.button() == 1:
            ...
            #     x=[p[0] for p in self.initial_region_seeds + [self.initial_region_seeds[0]]],
            #     y=[p[1] for p in self.initial_region_seeds + [self.initial_region_seeds[0]]])
    ...
    def undo_last_point(self):
        ...
        if self.initial_region_seeds:
            ...
            # if len(self.initial_region_seeds) > 1:
            #     self.contour_line_item.setData(
            #         x=[p[0] for p in self.initial_region_seeds + [self.initial_region_seeds[0]]]
            #         , y=[p[1] for p in self.initial_region_seeds + [self.initial_region_seeds[0]]])
            # else:
